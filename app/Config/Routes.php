...
$routes->get('/politicas-privacidad', 'Home::politicasPrivacidad');
$routes->get('/preguntas-frecuentes', 'Home::preguntas');
...
$routes->group('', ['filter' => 'authUser'], function ($routes) {
    ...
    $routes->post('Carrito_sync', 'Carrito_controller::Carrito_sync');
    ...
    $routes->post('/comprar', 'Carrito_controller::confirmar_compra');
