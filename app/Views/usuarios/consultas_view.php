  ...
  <div class="card">
    <div class="card-header">
      <div class="d-flex justify-content-between align-items-center">
        <h3 class="text-left mb-0">Consultas </h3>
        <div>
          <a class="btn btn-xs ml-2" style="background-color: lightgreen; color: black;" href="<?php echo base_url('consultasResueltas'); ?>">
            <i class="bi bi-plus-circle-fill" style="color: black"></i> Resueltas
          </a>
        </div>
      </div>
    </div>
            ...
            <?php if ($consultas) : ?>
              <?php foreach ($consultas as $cons) : ?>
                <tr>
                  ...
                  <td>
                    <a href="<?php echo base_url('Contactocontroller/deleteConsulta/' . $cons['id']) ?>">
                      <i class="bi bi-trash3" style="color: red; font-size: 1.5em;">
                      </i>
                    </a>
                  </td>
                  </td>
